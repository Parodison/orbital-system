...
fun OrbitData.toSatellite(): Satellite {
    val engine = SGP4Engine(
        epoch = epoch,
        meanMotionRadPerMin = meanMotion * 2.0 * PI / MINUTES_PER_DAY,
        eccentricity = eccentricity,
        inclinationRad = inclination * DEGREES_TO_RADIANS,
        raanRad = raOfAscNode * DEGREES_TO_RADIANS,
        argPerigeeRad = argOfPericenter * DEGREES_TO_RADIANS,
        meanAnomalyRad = meanAnomaly * DEGREES_TO_RADIANS,
        bstar = bstar,
    )
    return Satellite(
        engine,
